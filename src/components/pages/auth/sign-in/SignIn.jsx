...
const SignIn = () => {
  ...
  const isError = useMemo(
    () => isErrorUsername || isErrorPassword || !userName || !passWord,
        ...
        <div className={styles["signin-box"]}>
          ...
          <div className={styles["inputs-field"]}>
            ...
            <Input
              ...
              errorMessage={
                "Password must contain 1 upper case, 1 special characters, 1 number and have length from 8 to 32 characters"
              }
            />
          </div>
